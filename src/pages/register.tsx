...
export default function RegisterPage() {
    ...
    const onSubmit = async (data: RegisterData) => {
        try {
            await authState.register(data.name, data.email, data.password);
    ...
    return (
        <div className="min-h-screen flex flex-col justify-center items-center gap-8 p-4">
            ...
            <section>
                <Form {...methods}>
                    <motion.form onSubmit={methods.handleSubmit(onSubmit)} className="flex flex-col gap-4 w-80">
                        <FormField
                        ...
                        <Button type="submit" disabled={authState.loading} className="w-full mt-4">
