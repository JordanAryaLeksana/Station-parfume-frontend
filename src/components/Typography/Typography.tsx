...
import TypographyProps from '@/Interface/ITypography';
import { poppins, montserrat } from '@/utils/font';
export default function Typography({
  ...
  return (
    <Component
      className={clsxm(
        [
          variant === 'Header' && montserrat.className,
          variant === 'Paragraph' && poppins.className,
        ],
        [
